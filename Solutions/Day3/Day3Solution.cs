...
namespace Solutions.Day3
{
    public class Day3Solution
    {
        public static void Run()
        {
            ...
            System.Console.WriteLine($"Day 3, part 1: {Part1(data)}");
            System.Console.WriteLine($"Day 3, part 2: {Part2(data)}\n");
        }
        ...
        // toboggan might be easy, it's certainly not safe: there's very minimal steering and the area is covered in trees.You'll need to see which angles will take you near the fewest trees.

        // Due to the local geology, trees in this area only grow on exact integer coordinates in a
        // grid.You make a map (your puzzle input) of the open squares(.) and trees(#) you can see. For example:
